...
class ProductListApi(generics.ListAPIView):
    queryset =  Product.objects.all().prefetch_related('variants__size_color')
    serializer_class = ProductSerializer
    permission_classes = (ModelViewSetsPermission,)

class ProductCreateApi(generics.CreateAPIView):
    queryset = Product.objects.prefetch_related('variants__size_color')
    serializer_class = ProductSerializer
    permission_classes = (IsOwnerAuth,)
...
class ProductDetailApiView(APIView):
    def get(self, request, pk):
        try:
            category = Product.objects.prefetch_related('variants__size_color').get(product_id=pk)
